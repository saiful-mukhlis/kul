...
import org.bmb.app.view.component.ScrollPane;
import org.bmb.app.view.component.TextArea;
...
//		name.setBorder(BorderFactory.createm
	...
	public void buildForm(ODatabaseDocumentTx db) {
		...
		builder.append(db, PelangganDao.fcode, code, 1, 1, 5);
		builder.append(db, PelangganDao.fname, name, 1, 3, 5);
		builder.append(db, PelangganDao.fpemilik, pemilik, 1, 5, 5);
		builder.append(db, PelangganDao.fnotelp, notelp, 1, 7, 5);
		builder.append(db, PelangganDao.falamat, sAlamat, 1, 9, 5);
